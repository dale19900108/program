 ...
 * 异步的HTTP请求对象，可设置代理
 */
public class lotServerAsyncClient {

    private static int socketTimeout = 1000;// 设置等待数据超时时间10秒钟 根据业务调整

    private static int connectTimeout = 1000;// 连接超时

    private static int poolSize = 10;// 连接池最大连接数
